...
// - Only global blocks (if any) should be visible on the site panel, and cannot be moved int other centre pane.
...
// I have comented this part out. It is responsible for quick access to the course management 
// Menu. Remove the comment to see how it works.
