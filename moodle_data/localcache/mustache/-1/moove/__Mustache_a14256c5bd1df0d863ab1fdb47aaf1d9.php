...
class __Mustache_a14256c5bd1df0d863ab1fdb47aaf1d9 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                       <div class="course-blocks" style = \' display:flex;
';
...
';
        $buffer .= $indent . '    
';
        $buffer .= $indent . '                        <a href =\'http://127.0.0.1/moodle4.1/moodle/login/index.php\'> <div class="beginers-course-info2" style = \'line-height: 30px;
';
        $buffer .= $indent . '                        display:flex;
';
        $buffer .= $indent . '                        flex-direction: column;
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                        <a href =\'http://127.0.0.1/moodle4.1/moodle/login/index.php\'> <div class="beginers-course-info3" style = \'line-height: 30px;
';
        $buffer .= $indent . '                        display:flex;
';
        $buffer .= $indent . '                        flex-direction: column;
