...
class __Mustache_915f234fb09514bcbde8a3ce21175b66 extends Mustache_Template
{
...
';
        $value = $context->find('courseindex');
        $buffer .= $this->section68b05d544cc01eb0e0e418444c1c2ed3($context, $indent, $value);
        $value = $context->find('hasblocks');
        $buffer .= $this->section4511920df20bf6fa7380cf2d268076a8($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div style = \'line-height: 100px; line-height: 30px;\'>
';
        $buffer .= $indent . '            ';
...
';
    ...
    private function section68b05d544cc01eb0e0e418444c1c2ed3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section4511920df20bf6fa7380cf2d268076a8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
