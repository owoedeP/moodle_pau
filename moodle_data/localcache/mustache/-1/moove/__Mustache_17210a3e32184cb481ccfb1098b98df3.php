...
class __Mustache_17210a3e32184cb481ccfb1098b98df3 extends Mustache_Template
{
...
';
            ...
            $buffer .= $this->section975f5d52ba67d4ea49dc498eb1e548de($context, $indent, $value);
            $buffer .= $indent . '</div>
';
        }
...
';
    ...
    private function section975f5d52ba67d4ea49dc498eb1e548de(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
