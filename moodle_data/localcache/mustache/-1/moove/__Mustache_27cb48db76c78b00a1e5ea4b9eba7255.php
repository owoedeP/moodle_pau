...
class __Mustache_27cb48db76c78b00a1e5ea4b9eba7255 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="col-md-4 column-center bg-primary">
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="footer-content-debugging footer-dark bg-primary text-light">
';
