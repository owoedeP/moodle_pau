...
class __Mustache_aca662ccdcf2c8af2928ad3a280ad931 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div id="course-blocks" style=\'display:flex; flex-direction: row; justify-content: 
';
        $buffer .= $indent . '    space-between; font-size: 13px;\'>
';
        $buffer .= $indent . '
';
