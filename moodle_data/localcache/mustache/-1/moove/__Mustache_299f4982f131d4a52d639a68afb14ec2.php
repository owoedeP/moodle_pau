...
class __Mustache_299f4982f131d4a52d639a68afb14ec2 extends Mustache_Template
{
...
';
        ...
        $buffer .= '" tabindex="-1">
';
        $buffer .= $indent . '        <div class="card-img dashboard-card-img" style="background-color:#003366;">
';
