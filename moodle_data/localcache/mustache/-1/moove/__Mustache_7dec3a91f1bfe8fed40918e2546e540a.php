...
class __Mustache_7dec3a91f1bfe8fed40918e2546e540a extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                       <div id="course-blocks" style = \' display:flex;
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                        <div id="beginers-course-info1" style = \'line-height: 30px;
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                        <a href =\'http://127.0.0.1/moodle4.1/moodle/login/index.php\'> <div class="beginers-head" style = \'font-size: 40px; font-weight: bold; margin-bottom: 40px;\'>Beginners</div>
';
        $buffer .= $indent . '                        <div id= "beginersheader" style = \'font-weight: bold;font-size: 17px;margin-bottom: 10px;\'>Starting your language journey!</div>
';
        $buffer .= $indent . '                        <div id= "beginersinfo">Building essential skills for effective communication!</div>
';
        $buffer .= $indent . '                        </div> </a>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    
';
        $buffer .= $indent . '                        <a href =\'http://127.0.0.1/moodle4.1/moodle/login/index.php\'> <div id="beginers-course-info2" style = \'line-height: 30px;
';
        $buffer .= $indent . '                        display:flex;
';
        $buffer .= $indent . '                        flex-direction: column;
...
';
        $buffer .= $indent . '                        <div id ="beginers-head" style = \'font-size: 40px; font-weight: bold; margin-bottom: 40px;\'>Intermediate</div>
';
...
';
        $buffer .= $indent . '                        <div id = "beginersinfo">Elevating your vocabulary, grammar, and communication prowess!</div>
';
        $buffer .= $indent . '                        </div> </a>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                        <a href =\'http://127.0.0.1/moodle4.1/moodle/login/index.php\'> <div id="beginers-course-info3" style = \'line-height: 30px;
';
        $buffer .= $indent . '                        display:flex;
';
        $buffer .= $indent . '                        flex-direction: column;
...
';
        $buffer .= $indent . '                        background-color: #003366;\'>
';
        $buffer .= $indent . '                        <div id ="beginers-head" style = \'font-size: 40px; font-weight: bold; margin-bottom: 40px;\'>Advanced</div>
';
        $buffer .= $indent . '                        <div id = "beginersheader" style = \'font-weight: bold;font-size: 17px;margin-bottom: 10px;\'>Advancing to excellence</div>
';
        $buffer .= $indent . '                        <div id = "beginersinfo">Refining complex language, grammar, and communication for professional and academic success!</div>
';
        $buffer .= $indent . '                        </div> </a> 
';
        $buffer .= $indent . '                        </div>
